 ...
 */
@EFapsUUID("f9548901-adc3-4b04-9d5e-496d861dcd09")
@EFapsApplication("eFaps-Kernel")
public abstract class DeleteAttributeSetHistoryTrigger_Base
    extends AbstractAttributeSetHistoryTrigger
{
    ...
    {
        return CICommon.HistoryAttributeSetDelete.getType();
    }
    ...
    {
        return new DeleteAttributeSetLog();
    }
}
